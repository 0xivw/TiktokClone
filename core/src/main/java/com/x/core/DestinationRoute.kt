...
import com.x.core.DestinationRoute.PassedKey.USER_ID
import com.x.core.DestinationRoute.PassedKey.VIDEO_INDEX
...
object DestinationRoute {
    ...
    const val FORMATTED_COMPLETE_CREATOR_VIDEO_ROUTE =
        "$CREATOR_PROFILE_ROUTE/{$USER_ID}/{$VIDEO_INDEX}"

    const val INBOX_ROUTE = "inbox_route"
    const val MY_PROFILE_ROUTE = "my_profile_route"
    const val FRIEND_ROUTE = "friend_route"
